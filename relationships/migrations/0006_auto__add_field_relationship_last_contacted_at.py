...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Relationship.last_contacted_at'
        db.add_column('relationships_relationship', 'last_contacted_at',
                      self.gf('django.db.models.fields.DateTimeField')(db_index=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Relationship.last_contacted_at'
        db.delete_column('relationships_relationship', 'last_contacted_at')
    ...
    models = {
        ...
        'relationships.relationship': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_contacted_at': ('django.db.models.fields.DateTimeField', [], {'db_index': 'True', 'null': 'True', 'blank': 'True'}),
